...
#define MMC_CAP2_PACKED_WR_CONTROL (1 << 16) 
#define MMC_CAP2_CLK_SCALE	(1 << 17)	
#define MMC_CAP2_STOP_REQUEST	(1 << 18)	
#define MMC_CAP2_CORE_RUNTIME_PM (1 << 19)
#define MMC_CAP2_SANITIZE	(1 << 20)		
#define MMC_CAP2_ASYNC_SDIO_IRQ_4BIT_MODE (1 << 21)

#define MMC_CAP2_HS400_1_8V	(1 << 22)        
#define MMC_CAP2_HS400_1_2V	(1 << 23)        
#define MMC_CAP2_CORE_PM       (1 << 24)       
...
void mmc_start_debounce_phase1(struct mmc_host *, unsigned long delay);
