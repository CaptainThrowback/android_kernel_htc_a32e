...
enum ACPU_STATE_FOOTPRINT {
	...
	ACPU_MUX_DIV_BEFORE_SAFE_PARENT_INIT = 0x10,
	ACPU_MD_BEFORE_SET_SAFE_RATE,
	ACPU_MD_BEFORE_SET_PARENT_RATE,
	ACPU_MD_BEFORE_ERR_SET_RATE,
	ACPU_MD_BEFORE_CLK_PREPARE,
	ACPU_MD_BEFORE_ERR_SET_PARENT_RATE,
	ACPU_MD_BEFORE_SET_RATE,
	ACPU_MD_BEFORE_ERR_CLK_UNPREPARE,
	ACPU_MD_BEFORE_CLK_UNPREPARE,
	ACPU_MD_BEFORE_RETURN,
	ACPU_MD_BEFORE_ERR_RETURN,

	
	ACPU_PLL_BEFORE_FIND_FREQ = 0x10,
	ACPU_PLL_ERR_NO_FREQ,
	ACPU_PLL_BEFORE_DISABLE,
	ACPU_PLL_BEFORE_SET_PLL,
	ACPU_PLL_BEFORE_ENABLE,
	ACPU_PLL_BEFORE_RETURN,

	
	ACPU_BEFORE_UPDATE_L2_BW = 0xf0,	
	ACPU_LEAVE = 0xff,			
};
...
enum HOTPLUG_ON_FOOTPRINT {
	HOF_ENTER,
	HOF_BEFORE_PREPARE_ENABLE_L2,
	HOF_BEFORE_PREPARE_ENABLE_CPU,
...
void store_pm_boot_vector_addr(phys_addr_t value);
